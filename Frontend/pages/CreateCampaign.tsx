...
const CreateCampaign: React.FC = () => {
  ...
  return (
    <div className="max-w-[1120px] mx-auto py-8 md:py-12 px-4 sm:px-6 lg:px-8">
      {/* Stepper */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
        <div className="lg:col-span-8 flex flex-col gap-6">
          <div className="bg-white dark:bg-surface-dark rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 p-8">
            {step === 1 && (
              <div className="space-y-8">
                <div>
                  ...
                  <input className="w-full px-4 py-3 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg text-lg outline-none focus:ring-2 focus:ring-primary" placeholder="e.g., Help the Smith Family Rebuild" />
                </div>
                <div>
                  <label className="block text-xl font-bold mb-2">Select a category</label>
                  <select className="w-full px-4 py-3 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-primary outline-none">
              ...
              <div className="space-y-10">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input className="w-full pl-14 pr-20 py-8 bg-gray-50 dark:bg-gray-900 border-gray-200 dark:border-gray-700 rounded-xl text-5xl font-black focus:ring-2 focus:ring-primary" defaultValue="10,000" />
              ...
              <div className="space-y-8">
                <div>
                   ...
                   <div className="mt-4 border-2 border-dashed border-gray-200 dark:border-gray-700 rounded-xl p-12 flex flex-col items-center gap-4 text-center">
                      ...
                      <button className="px-4 py-2 border border-gray-200 dark:border-gray-700 rounded-lg font-bold text-sm">Browse Files</button>
                   </div>
                </div>
              </div>
            )}
          ...
          <div className="flex flex-col-reverse sm:flex-row items-center justify-between gap-4">
            {step > 1 ? (
              <button onClick={prevStep} className="flex items-center gap-2 px-6 py-3 font-bold text-gray-500 hover:text-gray-900 transition-colors">
