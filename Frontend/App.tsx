...
const VerificationIntro = React.lazy(
  () => import("./src/pages/VerificationIntro"),
);
const VerificationUpload = React.lazy(
  () => import("./src/pages/VerificationUpload"),
);
const VerificationSelfie = React.lazy(
  () => import("./src/pages/VerificationSelfie"),
);
const VerificationPending = React.lazy(
  () => import("./src/pages/VerificationPending"),
);
...
const AdminOverview = React.lazy(
  () => import("./src/pages/admin/AdminOverview"),
);
const AdminCampaignModeration = React.lazy(
  () => import("./src/pages/admin/AdminCampaignModeration"),
);
const AdminUserManagement = React.lazy(
  () => import("./src/pages/admin/AdminUserManagement"),
);
...
const AdminSettings = React.lazy(
  () => import("./src/pages/admin/AdminSettings"),
);
...
const PublicSupportView = React.lazy(
  () => import("./src/pages/PublicSupportView"),
);
  ...
  useEffect(() => {
    ...
    const loadFont = async () => {
      try {
        ...
        const settings = response.data?.data as
          | { fontFamily?: string }
          | undefined;
        ...
        const selected =
          fontMap[settings.fontFamily] ?? '"Source Sans Pro", sans-serif';
            ...
            <Suspense fallback={<PageFallback />}>
              <Routes>
                ...
                >
                  ...
                  <Route
                    path="campaigns"
                    element={<AdminCampaignModeration />}
                  />
              ...
              <div className="relative w-full sm:w-105 bg-white dark:bg-surface-dark rounded-t-2xl sm:rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-800 p-6 m-0 sm:m-4">
                ...
                <div className="space-y-3">
                  <button className="w-full text-left p-3 rounded-lg border border-gray-100 dark:border-gray-800 hover:border-primary/40 hover:bg-primary/5 transition">
                    <p className="font-semibold">{t("app.help.q1Title")}</p>
                    <p className="text-sm text-gray-500">
                      {t("app.help.q1Body")}
                    </p>
                  </button>
                  <button className="w-full text-left p-3 rounded-lg border border-gray-100 dark:border-gray-800 hover:border-primary/40 hover:bg-primary/5 transition">
                    <p className="font-semibold">{t("app.help.q2Title")}</p>
                    <p className="text-sm text-gray-500">
                      {t("app.help.q2Body")}
                    </p>
                  </button>
